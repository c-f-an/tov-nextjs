...
const incomeBreakdown = [
  { category: "정기후원", amount: "0", percentage: 0 },
  { category: "일시후원", amount: "0", percentage: 0 },
  { category: "교육사업 수익", amount: "0", percentage: 0 },
  { category: "기타 수익", amount: "0", percentage: 0 },
];

const expenseBreakdown = [
  { category: "교육 프로그램", amount: "0", percentage: 0 },
  { category: "상담 서비스", amount: "0", percentage: 0 },
  { category: "연구개발", amount: "0", percentage: 0 },
  { category: "운영비", amount: "0", percentage: 0 },
];
  ...
  return (
    <div className="container mx-auto px-4 py-8">
            ...
            <table className="w-full">
              ...
              <tbody>
                {financialReports.length > 0 ? (
                  financialReports.slice(0, 10).map((report, index) => (
                  ...
                  <tr className="w-full text-center">
                    <td colSpan={5}>보고서가 없습니다.</td>
                  </tr>
                )}
              </tbody>
            </table>
          </div>
          {financialReports.length > 10 && (
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <Card>
          <CardHeader>
            <CardTitle>2025년 1분기 수입 내역</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle>2025년 1분기 지출 내역</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
