...
function NewReportForm() {
  ...
  const defaultType = searchParams.get('type') as 'business' | 'finance' || 'business';
      ...
      <div>
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-1">
            {formData.type === 'business' ? '사업보고서' : '재정보고서'}를 작성합니다
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6">
          ...
          <div className="mb-6">
            ...
            <select
              value={formData.type}
              onChange={(e) => setFormData({ ...formData, type: e.target.value as 'business' | 'finance' })}
              ...
              {formData.file_url && (
                <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-md">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-gray-700">파일이 업로드되었습니다</p>
                    <a
