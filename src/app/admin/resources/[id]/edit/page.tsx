        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6">
          ...
          {resource?.filePath && (
            <div className="mt-6 p-4 bg-gray-50 rounded">
              ...
              <div className="text-sm text-gray-600">
                ...
                <p>파일 크기: {resource.fileSize ? `${(resource.fileSize / 1024).toFixed(2)} KB` : 'N/A'}</p>
              </div>
            </div>
          )}
            ...
            <div className="space-y-3">
              <label className="flex items-center">
                <input
                  ...
                  className="mr-2"
                />
                <span className="text-sm font-medium text-gray-700">주요 자료로 표시</span>
              </label>
          ...
          {resource && (
            <div className="mt-6 p-4 bg-blue-50 rounded">
              <h3 className="text-sm font-medium text-gray-700 mb-2">통계 정보</h3>
