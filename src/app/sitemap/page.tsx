      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-12 bg-gray-50 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600">
            <div>
              <p className="mb-2"><strong>운영기관:</strong> 사단법인 토브협회</p>
              <p className="mb-2"><strong>대표자:</strong> 홍길동</p>
              <p className="mb-2"><strong>사업자등록번호:</strong> 123-45-67890</p>
            </div>
            <div>
              <p className="mb-2"><strong>주소:</strong> 서울특별시 강남구 ○○로 123</p>
              <p className="mb-2"><strong>전화:</strong> 02-1234-5678</p>
              <p className="mb-2"><strong>이메일:</strong> info@tov.or.kr</p>
            </div>
          </div>
        </div>
      </div>
