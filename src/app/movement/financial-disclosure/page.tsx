  ...
  return (
    <main className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-16">
        <h1 className="text-4xl font-bold text-center mb-8">결산서 공개 운동</h1>
        
        <div className="max-w-4xl mx-auto">
          <div className="bg-white p-8 rounded-lg shadow-md mb-8">
            <p className="text-lg text-gray-700 mb-6">
              결산서 공개 운동은 교회와 비영리단체의 재정 투명성을 높이고, 
              후원자와 구성원들의 신뢰를 강화하기 위한 자발적 참여 캠페인입니다.
            </p>
          </div>

          <div className="bg-blue-50 p-8 rounded-lg mb-8">
            <h2 className="text-2xl font-bold mb-4">왜 결산서를 공개해야 할까요?</h2>
          ...
          <div className="bg-white border-2 border-blue-200 p-8 rounded-lg mb-8">
            ...
            <div className="space-y-4">
              ...
              <div className="border-b pb-4">
                ...
                <p className="text-gray-600">
                  분기별 재정보고서를 홈페이지와 소식지에 공개. 
                  후원금 사용 내역을 구체적으로 명시하여 후원자 증가.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-lg">□□선교회</h3>
                <p className="text-gray-600">
                  외부 회계감사를 받은 결산서를 매년 공개. 
                  투명한 재정운영으로 기업 후원 유치 성공.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-100 p-8 rounded-lg">
            <h2 className="text-2xl font-bold mb-4">결산서 공개 운동 참여하기</h2>
            ...
            <div className="space-y-2 mb-6">
              ...
              <p className="text-gray-700">
                <strong>이메일:</strong> disclosure@tov.or.kr
              </p>
            </div>
