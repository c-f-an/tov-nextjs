  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mx-auto">
        ...
        />
        <h1 className="text-4xl font-bold mb-8 text-center">사업보고</h1>

        <div className="mb-8 text-center">
          <p className="text-lg text-gray-600 mx-auto">
            투명함’의 약속 | Tov의 사명을 실현하는 이야기입니다.
          </p>
        </div>
          ...
          <div className="text-center">
            ...
            <div className="grid md:grid-cols-2 gap-6 mx-auto">
              <div className="bg-white/10 rounded-lg p-6">
                ...
                <p>
                  재정이 어려운 소규모 교회를 위한 무료 상담 및 교육 프로그램을
                  운영합니다.
                </p>
              </div>
              <div className="bg-white/10 rounded-lg p-6">
                ...
                <p>
                  새롭게 설립된 교회가 올바른 세무 시스템을 구축할 수 있도록
                  지원합니다.
                </p>
              </div>
            </div>
