...
export class User implements IUser {
  ...
  static create(params: Omit<IUser, 'id' | 'createdAt' | 'updatedAt' | 'status' | 'emailVerifiedAt' | 'lastLoginAt' | 'lastLoginIp' | 'rememberToken' | 'role' | 'userType'> & { userType?: UserType }): User {
    return new User(
