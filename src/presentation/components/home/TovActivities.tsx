...
const activities = [
  {
    id: 1,
    title: '건강한 재정관리',
    description: '교회와 비영리단체의 투명하고 체계적인 재정관리를 위한 컨설팅과 교육을 제공합니다.',
    icon: DollarSign,
  ...
  },
  {
    id: 2,
    title: '건강한 재정 교육',
    description: '재정 투명성의 중요성과 실천 방법을 교육하여 건강한 재정 문화 확산에 기여합니다.',
    icon: BookOpen,
  ...
  },
  {
    id: 3,
    title: '결산서 공개 운동',
    description: '자발적 결산서 공개를 통해 교회와 비영리단체의 재정 투명성을 향상시킵니다.',
    icon: Users,
  ...
  },
  {
    id: 4,
    title: '연대협력',
    description: '투명한 재정 문화 확산을 위해 다양한 기관과 협력하여 시너지를 창출합니다.',
    icon: HandshakeIcon,
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-8">
      <div className="flex items-center justify-between mb-6">
        ...
        <Link href="/movement" className="text-sm text-blue-600 hover:underline">
          전체보기 →
        </Link>
      </div>
        ...
        {activities.map((activity) => {
          ...
          return (
            <Link
              ...
              className="group"
            >
              <div className={`${activity.bgColor} rounded-lg p-6 h-full ${activity.hoverBg} transition-colors`}>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="mb-4 md:mb-0">
            ...
            <p className="text-gray-600">
              토브협회는 교회와 비영리단체의 재정 투명성 향상을 위해 다양한 활동을 펼치고 있습니다.
            </p>
          </div>
